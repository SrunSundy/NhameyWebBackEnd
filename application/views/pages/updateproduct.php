...
<html>
  <head>
    ...
    <title>Update Product | Dernham</title>
  ...
  <body class="hold-transition skin-red-light sidebar-mini">
      ...
      <div class="content-wrapper" >
      	 <!-- wrapper of both profile and cover -->  
       	 	...
       	 	<div class="col-lg-9 cover-wrapper-left" >
       	 		<div class="row">
	       	 		...
	       	 		<div class="bar-cover-wrapper">
	       	 			<?php include 'elements/updateproduct/cover.php';?>
	       	 		</div>
	       	 				...
	       	 				<div class="row">
	       	 					...
	       	 					<div class="menu-arrow">
	       	 						<div class="menu-arrow-inside">
											...
											<li class="item-small">
												<input type="hidden" value="updatepro_information" />
	       	 			...
	       	 			<div class="col-lg-12 shop-edit-form-wrapper" style="padding-bottom:50px;position:relative;">
	       	 				<div class="row" >	       	 						       	 						       	 					
	       	 					<iframe style="width:100%;height:auto;display:none;" id="updateShopframe" 
          							  scrolling="no" frameborder="0" marginheight="0" marginwidth="0" src="<?php echo base_url(); ?>MainController/updatepro_information/<?php echo $product_id?>">
		    ...
		    <div class="col-lg-3 profilemenu-wrapper-right">
		    	<?php include 'elements/updateproduct/logomenu.php';?>
		    </div>
		    <div style="clear:both;"></div>
    ...
    <script src="<?php echo base_url(); ?>assets/nhamdis/jscontroller/updateproduct.js"></script>
	...
	$("li.item, li.item-small").on("click", function(){
		...
		$("#updateShopframe").attr("src","<?php echo base_url(); ?>MainController/"+tabid+"/"+$("#product_id").val());
	});
