...
<html>
  <head>
    ...
    <title>Product list | Dernham</title>
  ...
  <body class="hold-transition skin-red-light sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Product Management
            <small>Manage all the Product</small>
          </h1>
          <ol class="breadcrumb">
   ...
   <script id="display-shop-table" type="text/x-jQuery-tmpl">
			...
			<td>
           	...
           	<td>				
				{{= pro_name_en }} 
			{{if pro_name_kh || pro_name_kh != ""}}
				({{= pro_name_kh }})
			{{/if}}
				
			</td>
            <td>{{=  trimString(pro_created_date,0, 10)  }} <span class="shop-open-time">{{=  trimString(pro_created_date, 10 , 16)  }}</span></td>
           
 			<td>{{= pro_view_count }}</td>
 			
 			<td >
				<div class="progress" style="background: #E0E0E0" title="{{= pro_remark }}">
    ...
    <script src="<?php echo base_url(); ?>assets/nhamdis/jscontroller/listproduct.js"></script>
  </body>
</html>
