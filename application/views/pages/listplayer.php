    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Player Management
            <small>manage all the Player</small>
          </h1>
          <ol class="breadcrumb">
		...
		<tr>					
			<td>
           	...
           	<td>				
				...
				<div class="shop-open-time">{{= user_gender }} </div>
			</td>
            ...
            <td>{{= user_email }}</td>
 			...
 			<td>{{= user_quote }}</td>
 			<td >
				<div class="progress" style="background: #E0E0E0" title="">
 			...
 			<td>
				<label class="switch">
  					<input class="toggleshop" id="{{= generateIdWithShopId('toggleshop',user_id)}}" type="checkbox" {{= checkShopStatus(user_status)}}>
