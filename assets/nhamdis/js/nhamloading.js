...
var progressbar = {
	...
	start : function(){
		...
		var load_img = '<div class="custom_nham_loading_img" style="width: 100%;height:100%;position:fixed;top:0;left:0;z-index:9999999">'
			+ '<div id="start_progress_bar" class="progress-bar progress-bar-danger progress-bar-striped" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="height:5px;position:absolute;top:0;left:0;" > </div>'
			+ '<div style="width:80px;margin:0 auto;"><img src="/NhameyWebBackEnd/assets/nhamdis/img/ring.svg" style="position:absolute;top:40%;"/></div>'
			+ '</div>';
